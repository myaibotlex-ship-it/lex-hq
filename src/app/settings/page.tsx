  ...
  return (
    <div className="p-4 md:p-6 max-w-4xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-zinc-500 text-sm">Configure The Bridge</p>
      </div>
          ...
          <CardContent>
            <div className="flex gap-3">
              ...
              <button
                ...
                disabled
                className="flex items-center gap-2 px-4 py-2 rounded-lg border bg-zinc-800/30 border-zinc-700 text-zinc-600 cursor-not-allowed"
                title="Coming soon"
              >
                ☀️ Light
        ...
        <Card className="bg-zinc-900/80 border-zinc-800">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <h4 className="text-xs font-semibold text-zinc-500 uppercase tracking-wider">Navigation</h4>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-zinc-500">Command Center for Lex & Agents</p>
                </div>
              </div>
